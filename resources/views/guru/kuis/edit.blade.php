...
<div class="max-w-6xl mx-auto" x-data="quizBuilder()">
    <form method="POST" action="{{ route('guru.kuis.update', $kuis) }}" enctype="multipart/form-data" @submit="validateBeforeSubmit">
        @csrf
        @method('PUT')
        ...
        <div class="flex gap-4">
            <button type="submit" aria-label="Perbarui Kuis Penuh"
