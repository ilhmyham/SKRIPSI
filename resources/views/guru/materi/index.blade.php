            ...
            <x-card :interactive="true">
                <div class="flex items-start justify-between mb-4">
                    ...
                    <div class="p-3 bg-emerald-100 rounded-full">
                        <x-icon name="book" class="w-6 h-6 text-emerald-600" aria-hidden="true" />
                    </div>
                </div>
                ...
                <a href="{{ route('guru.materi.by-module', $module) }}" aria-label="Kelola Materi {{ $module->nama_modul }}"
    ...
    @if($modules->isEmpty())
        <x-card>
            <div class="text-center py-12">
                <x-icon name="book" class="w-16 h-16 mx-auto mb-4 text-gray-300" aria-hidden="true" />
