    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div class="card">
            ...
            <div class="grid grid-cols-2 gap-3">
                ...
                <a href="{{ route('guru.materi.index') }}" aria-label="Akses Manajemen Materi"
                    class="btn btn-primary text-center text-sm focus-visible:outline-gray-900">
                    <x-icon name="plus" class="w-5 h-5" aria-hidden="true" />
                    Tambah Materi
                </a>
                {{-- <a href="{{ route('guru.kuis.create') }}" aria-label="Buat Kuis Baru"
                    class="btn btn-primary text-center text-sm focus-visible:outline-gray-900">
                    <x-icon name="plus" class="w-5 h-5" aria-hidden="true" />
                    Buat Kuis
                </a> --}}
                ...
                <a href="{{ route('guru.progress.index') }}" aria-label="Lihat Kemajuan Belajar Siswa"
                    class="btn btn-secondary text-center text-sm focus-visible:outline-gray-600">
                    <x-icon name="chart-bar" class="w-5 h-5" aria-hidden="true" />
                    Progress Siswa
                </a>
                <a href="{{ route('guru.kuis.monitoring') }}" aria-label="Lihat Hasil Kuis Siswa"
                    class="btn btn-secondary text-center text-sm focus-visible:outline-gray-600">
