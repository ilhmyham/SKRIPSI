...
<div class="pb-24 min-h-screen bg-gray-50">
    ...
    <div class="bg-gradient-to-br from-emerald-600 via-emerald-700 to-emerald-900 pt-10 pb-20 px-5 relative overflow-hidden">
        ...
        <div class="max-w-2xl mx-auto relative z-10">
            <a href="{{ route('siswa.tugas.index') }}" aria-label="Kembali ke Daftar Tugas" class="inline-flex items-center gap-1.5 text-emerald-200 hover:text-white text-sm font-semibold mb-4 transition-colors focus-visible:outline-white">
            ...
            <div class="px-6 py-4 border-b border-gray-100 bg-emerald-50">
                <div class="flex items-center gap-2">
                    <div class="w-6 h-6 rounded-full bg-emerald-600 flex items-center justify-center">
                        <svg aria-hidden="true" class="w-3.5 h-3.5 text-white" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div class="px-6 py-5 space-y-5">
                ...
                <div class="flex items-start gap-4">
                    <div class="flex-shrink-0 w-10 h-10 rounded-xl bg-indigo-100 flex items-center justify-center">
                        <svg aria-hidden="true" class="w-5 h-5 text-indigo-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"/>
                        </svg>
                    </div>
                    <div class="flex-1">
                        <p class="text-xs font-bold text-gray-400 uppercase tracking-wide mb-1">File Jawaban</p>
                        <a href="{{ asset('storage/' . $pengumpulan->file_jawaban) }}" aria-label="Download File Jawaban yang telah dikumpulkan"
                           target="_blank"
                           class="inline-flex items-center gap-2 text-sm font-bold text-indigo-600 hover:text-indigo-800 hover:underline transition-colors focus-visible:outline-indigo-500">
                            <svg aria-hidden="true" class="w-4 h-4" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <div class="flex items-start gap-4">
                    <div class="flex-shrink-0 w-10 h-10 rounded-xl bg-gray-100 flex items-center justify-center">
                        <svg aria-hidden="true" class="w-5 h-5 text-gray-500" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    @else
                        <div class="flex items-center gap-3 p-4 bg-amber-50 rounded-2xl border border-amber-200">
                            <div class="flex-shrink-0 w-8 h-8 rounded-full bg-amber-100 flex items-center justify-center">
                                <svg aria-hidden="true" class="w-4 h-4 text-amber-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
                                </svg>
                            </div>
                            <div>
        ...
        <div class="bg-white rounded-3xl shadow-xl border border-gray-100 overflow-hidden">
            ...
            <div class="px-6 py-6">
                ...
                <div class="flex items-center gap-3 p-4 bg-red-50 rounded-2xl border border-red-200 mb-5">
                    <svg aria-hidden="true" class="w-5 h-5 text-red-500 flex-shrink-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                ...
                <form method="POST" action="{{ route('siswa.tugas.submit', $tugas) }}" enctype="multipart/form-data" class="space-y-5">
                    ...
                    <div x-data="{ fileName: '', dragging: false }"
                        ...
                        <label for="file" class="block mb-2 text-sm font-bold text-gray-700">File Tugas</label>
                        <div :class="dragging ? 'border-indigo-400 bg-indigo-50' : 'border-gray-200 bg-gray-50 hover:border-indigo-300'"
                            ...
                            <input x-ref="fileInput" type="file" name="file" id="file" required accept=".pdf,.doc,.docx,.jpg,.jpeg,.png"
                                   class="hidden"
                                ...
                                <div>
                                    <div class="flex justify-center mb-3">
                                        <div class="w-14 h-14 rounded-2xl bg-indigo-100 flex items-center justify-center">
                                            <svg aria-hidden="true" class="w-7 h-7 text-indigo-500" fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24">
                            ...
                            <template x-if="fileName">
                                <div class="flex items-center justify-center gap-3">
                                    <div class="w-10 h-10 rounded-xl bg-emerald-100 flex items-center justify-center">
                                        <svg aria-hidden="true" class="w-5 h-5 text-emerald-600" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                    ...
                    <button type="submit" aria-label="Kumpulkan Jawaban Tugas"
                            class="w-full flex items-center justify-center gap-3 bg-emerald-600 hover:bg-emerald-700 active:scale-[0.98] text-white font-black text-base py-4 rounded-2xl shadow-lg shadow-emerald-200 transition-all duration-200 focus-visible:outline-emerald-600 focus-visible:outline-offset-2">
