    ...
    <aside :class="isSidebarOpen ? 'w-64' : 'w-20'" class="bg-gray-900 text-white flex flex-col sticky top-0 h-screen transition-all duration-300">
        ...
        <nav class="flex-1 px-4 py-6 space-y-2 overflow-y-auto overflow-x-hidden">
            <a href="{{ route('admin.dashboard') }}" 
               title="Dashboard"
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.dashboard') ? 'bg-white text-gray-900' : 'text-gray-300 hover:bg-gray-800' }}"
            ...
            <a href="{{ route('admin.users.index') }}" 
               ...
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.users.*') ? 'bg-white text-gray-900' : 'text-gray-300 hover:bg-gray-800' }}"
               :class="!isSidebarOpen && 'justify-center px-0'">
            ...
            <a href="{{ route('admin.modules.index') }}" 
               ...
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.modules.*') ? 'bg-white text-gray-900' : 'text-gray-300 hover:bg-gray-800' }}"
               :class="!isSidebarOpen && 'justify-center px-0'">
            ...
            <a href="{{ route('admin.materi.index') }}" 
               ...
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.materi.*') ? 'bg-white text-gray-900' : 'text-gray-300 hover:bg-gray-800' }}"
               :class="!isSidebarOpen && 'justify-center px-0'">
            ...
            <a href="{{ route('admin.kuis.index') }}" 
               ...
               class="flex items-center gap-3 px-4 py-3 rounded-lg transition {{ request()->routeIs('admin.kuis.*') ? 'bg-white text-gray-900' : 'text-gray-300 hover:bg-gray-800' }}"
               :class="!isSidebarOpen && 'justify-center px-0'">
