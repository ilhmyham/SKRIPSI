...
<div class="flex h-screen"
    ...
    >
        ...
        <nav class="flex-1 px-3 py-5 space-y-1 overflow-y-auto overflow-x-hidden" aria-label="Menu Admin">
            <div x-show="isSidebarOpen || isMobile" class="px-3 pb-1 pt-2 text-[10px] font-bold uppercase tracking-widest text-gray-500">Utama</div>
            ...
            <div x-show="isSidebarOpen || isMobile" class="px-3 pb-1 pt-2 text-[10px] font-bold uppercase tracking-widest text-gray-500">Sistem</div>
            ...
            <div class="my-2 border-t border-gray-700/60"></div>
            <div x-show="isSidebarOpen || isMobile" class="px-3 pb-1 pt-2 text-[10px] font-bold uppercase tracking-widest text-gray-500">Pendidikan</div>
            ...
            <div class="px-4 sm:px-6 py-3 flex items-center justify-between gap-3">
                ...
                <div class="relative shrink-0">
                    <button @click="profileOpen = !profileOpen"
                        ...
                        <div class="w-9 h-9 bg-blue-500 rounded-full flex items-center justify-center text-white font-bold text-sm shrink-0">
