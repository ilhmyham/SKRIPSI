            ...
            @if(session('success'))
                <div x-data="{ show: true }" 
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button aria-label="Tutup pesan sukses" @click="show = false" class="text-green-600 hover:text-green-800 transition focus-visible:outline-green-600 focus-visible:outline-offset-2 rounded px-1">
            ...
            @if(session('error'))
                <div x-data="{ show: true }" 
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <button aria-label="Tutup pesan error" @click="show = false" class="text-red-600 hover:text-red-800 transition focus-visible:outline-red-600 focus-visible:outline-offset-2 rounded px-1">
                            <svg aria-hidden="true" class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
                                <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"/>
                            </svg>
                        </button>
