...
$icons = [
    ...
    'academic-cap' => '<path fill-rule="evenodd" d="M12 1.586L.293 13.293a1 1 0 001.414 1.414L12 4.414 22.293 14.707a1 1 0 001.414-1.414L12 1.586z" clip-rule="evenodd"/><path d="M19 13v5.586l-7 7-7-7V13"/>',
    
    // Quiz & Tasks
    'kuis' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2m-6 9l2 2 4-4"/>',
...
<svg class="<?php echo e($class); ?>" fill="<?php echo e($fill); ?>" stroke="<?php echo e($stroke); ?>" viewBox="0 0 24 24" <?php echo e($attributes); ?>>
    <?php echo $icons[$name] ?? $icons['file']; ?>

</svg>
<?php /**PATH D:\Ums\semester7\Skripsi\aplikasi\Ayatisyarat6\app6\resources\views/components/icon.blade.php ENDPATH**/ ?>